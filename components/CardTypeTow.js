...
const CardTypeTow = (props) => {

  if(props.opacity ) {
  return(  <article className=" opacity-40 bg-card p-2 w-[18rem] h-[20rem] flex justify-center flex-col items-center  ">
  ...
  <div className="p-2 flex flex-col justify-between align-middle mt-3 w-full items-center  ">
    ...
    <div className="flex justify-between  w-full mt-4 capitalize ">
      <h5 className=" text-base opacity-50 text-white  ">
        {" "}
        current bit{" "}
      </h5>
    ...
    return(  <article className="  bg-card p-2 w-[18rem] h-[20rem] flex justify-center flex-col items-center  ">
    <div className=" w-[16rem]  h-[14rem] overflow-hidden mt-2 relative">
      <Image
        src={props.image}
        alt="ImageCard"
